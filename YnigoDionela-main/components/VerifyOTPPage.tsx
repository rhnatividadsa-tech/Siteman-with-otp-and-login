...
export default function VerifyOTPPage({ onBack, onNext }: VerifyOTPPageProps) {
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <p style={{ fontFamily: "'Sora',sans-serif", fontSize: "10px", fontWeight: "600", letterSpacing: "3px", color: "rgba(255,255,255,0.35)", marginBottom: "24px", textTransform: "uppercase" }}></p>
      ...
      <div style={{ width: "340px", background: "#f6f7fc", padding: "48px 36px", display: "flex", flexDirection: "column", overflowY: "auto", height: "100vh" }}>
        ...
        <p style={{ fontSize: "13px", color: "#64748b", marginBottom: "32px", lineHeight: "1.55" }}>
          We've sent a 6-digit verification code to your registered mobile number ending in •••• 8821.
        </p>
        ...
        <div style={{ marginTop: "24px", textAlign: "center", fontSize: "12.5px", color: "#94a3b8", paddingBottom: "20px" }}>
          ...
          {" · "}
          <a href="#" style={{ color: "#5E70DC", textDecoration: "none", fontWeight: "500" }}>Change Number</a>
        </div>
      </div>
    </div>
  );
